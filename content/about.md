...
- GitHub: [YOONKY-KOR](https://github.com/YOONKY-KOR)
...
| [Architecture](/architecture/) | 클라우드 아키텍처 설계 노트 시리즈 | 운영 중 (1편) |
...
- Engineering Knowledge Base (Azure 에러 이력, 고객 메일 데이터)
